...
本册是 AI-PLAT 用户手册的第一部分，适合首次接触平台的企业客户阅读。通过本册，读者可以了解平台定位、适用对象、使用前准备、账号登录配置以及项目入口。

阅读衔接：本册完成后，建议继续阅读《AI-PLAT用户手册（二）：核心功能操作指南》，进入数据、组件、工作流、模型和部署等实际操作。
...
完成本册后，客户应已具备登录平台、识别首页入口、进入项目空间的基础能力。下一册《AI-PLAT用户手册（二）：核心功能操作指南》将从项目创建和成员管理开始，继续说明组件获取、资源上传、标注任务、工作流运行、模型训练、模型预测和部署验证等核心操作。
