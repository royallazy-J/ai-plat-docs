...
const docs = [
  {
    file: "AI-PLAT用户手册-02-00核心功能操作指南总览.md",
    title: "第二部分：核心功能操作指南",
    intro: "本部分将 AI-PLAT 的核心操作拆分为 7 个连续专题，覆盖项目准备、资源管理、标注、工作流、训练、发布与部署。可按实际任务直接进入对应专题，也可按推荐主线依次完成。",
    ...
    next: "从《01 项目与组件准备》开始，或根据当前任务直接进入对应专题。"
  },
  {
